...
<div class="element">
    ...
    <select name="WorkflowEvent_event_approvelocation_section_{$event.id}[]" size="5" multiple="multiple">
...
<div class="element">
    ...
    <select name="WorkflowEvent_event_approvelocation_languages_{$event.id}[]" size="5" multiple="multiple">
